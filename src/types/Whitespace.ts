 ...
 */
export type RemoveWhitespaceOnlyStringsFromTuple<T extends unknown[]> =
  T extends [infer R, ...infer Rest]
    ? R extends string
      ? Trim<R> extends ""
        ? RemoveWhitespaceOnlyStringsFromTuple<Rest>
        : [R, ...RemoveWhitespaceOnlyStringsFromTuple<Rest>]
      : []
    : [];
